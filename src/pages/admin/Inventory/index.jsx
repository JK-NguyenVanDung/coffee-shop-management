          ...
          <div className="auth-inner">
            ...
            <div className="form-cont" >
              ...
              >
                ...
                >
                  <Input className='email' suffix={<MailOutlined />} placeholder="Vui lòng nhập email tài khoản của bạn" type="email" style={{with: '100%'}} />
                </Form.Item>

                <Form.Item style={{ marginTop: 35 }}>
                  <Spin indicator={antIcon} spinning={loading}  >
                    <Button type="primary" htmlType="submit" block size="large" style={{ background: "#111", width: "50%", justifySelf: 'center', border: 'none', marginLeft: '25%' }}>
                      Xác nhận
                    </Button>
                  </Spin>
                </Form.Item>
